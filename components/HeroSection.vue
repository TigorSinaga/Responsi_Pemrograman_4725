            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  <img src="/assets/img/foto.jpg" alt="Admin" class="" width="150" />
                  <div class="mt-3">
            ...
            <div class="card mt-3">
              <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  ...
                  <span class="text-secondary">tigorsinaga.github.io</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                    <svg
                  ...
                  <span class="text-secondary">TigorSinaga</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                    <svg
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  ...
                  <span class="text-secondary">@tigorsnaga</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                    <svg
                  ...
                  <span class="text-secondary">Tigor Sinaga</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="card mb-3">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">Tigor Neilson Sinaga</div>
                </div>
                <hr />
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">tigorsinaga3030@gmail.com</div>
                </div>
                <hr />
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">082397088557</div>
                </div>
                <hr />
                <div class="row">
                  <div class="col-sm-3">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">Sleman, Yogyakarta</div>
                </div>
                <hr />
                <div class="row"></div>
              </div>
              ...
              <div class="col-sm-6 mb-3">
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <div class="progress mb-3" style="height: 5px">
                      <div class="progress-bar bg-primary" role="progressbar" style="width: 15%" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
